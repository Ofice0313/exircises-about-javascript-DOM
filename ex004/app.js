...
range_1.addEventListener('input', (event) => {
    document.querySelector('#value_1').innerHTML = event.target.value;
});
...
range_2.addEventListener('input', (event) => {
    document.querySelector('#value_2').innerHTML = event.target.value;
});
...
range_3.addEventListener('input', (event) => {
    document.querySelector('#value_3').innerHTML = event.target.value;
});
